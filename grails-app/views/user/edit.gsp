  ...
  <div class="row mb-4">
    <div class="col-12">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <g:link action="index">Users</g:link>
          </li>
          <li class="breadcrumb-item">
      ...
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group">
          <g:link action="show" id="${user.id}" class="btn btn-outline-info">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row align-items-center">
            <div class="col-md-6">
              <h5 class="mb-0">
                <i class="fas fa-user-circle me-2"></i>Edit User Information
              </h5>
            </div>
        ...
        <div class="card-body">
          <g:form action="update" id="${user.id}" method="POST" class="needs-validation" novalidate="novalidate">
            <g:hiddenField name="version" value="${user.version}" />

            <!-- User Info Header -->
            <div class="row mb-4">
              <div class="col-md-2 text-center">
                <div class="avatar-edit bg-primary text-white rounded-circle d-flex align-items-center justify-content-center mx-auto mb-2">
                  ${user.initials}
                </div>
              ...
              <div class="col-md-10">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control ${hasErrors(bean: user, field: 'fullName', 'is-invalid')}"
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="email" class="form-control ${hasErrors(bean: user, field: 'username', 'is-invalid')}"
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="email" class="form-control ${hasErrors(bean: user, field: 'email', 'is-invalid')}"
                       id="email" name="email"
                       value="${user.email}"
                       placeholder="user@example.com"
                       required>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="tel" class="form-control ${hasErrors(bean: user, field: 'phone', 'is-invalid')}"
                       id="phone" name="phone"
                       value="${user.phone}"
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox"
                                 id="accountExpired" name="accountExpired"
                            ${user.accountExpired ? 'checked' : ''}>
                      ...
                      <div class="col-6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox"
                                 id="accountLocked" name="accountLocked"
                            ${user.accountLocked ? 'checked' : ''}>
                      ...
                      <div class="col-6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox"
                                 id="passwordExpired" name="passwordExpired"
                            ${user.passwordExpired ? 'checked' : ''}>
                  ...
                  <div class="card-body">
                    <g:each in="${roles}" var="role">
                      <div class="form-check mb-2">
                        <input class="form-check-input" type="checkbox"
                               name="selectedRoles" value="${role.id}"
                               id="role_${role.id}"
                          ${selectedRoles?.contains(role.id) ? 'checked' : ''}>
                        <label class="form-check-label" for="role_${role.id}">
                          <g:if test="${role.authority == 'ROLE_ADMIN'}">
                            <span class="badge bg-danger p-2">${role.authority}</span>
                            <small class="text-muted ms-2">Full system access</small>
                          </g:if>
                          <g:elseif test="${role.authority == 'ROLE_SUPERVISOR'}">
                            <span class="badge bg-warning p-2">${role.authority}</span>
                            <small class="text-muted ms-2">Can manage interns</small>
                          </g:elseif>
                          <g:else>
                            <span class="badge bg-info p-2">${role.authority}</span>
                            <small class="text-muted ms-2">Basic intern access</small>
                          </g:else>
                        </label>
                      </div>
                    </g:each>
            ...
            <div class="d-flex justify-content-between mt-4">
              <div>
                <g:link action="show" id="${user.id}" class="btn btn-secondary me-2">
  ...
  $(document).ready(function() {
    ...
    $('#password, #confirmPassword').on('keyup', function() {
      ...
      if (password && confirmPassword) {
        if (password === confirmPassword) {
          matchDiv.html('<span class="text-success"><i class="fas fa-check-circle me-1"></i>Passwords match</span>');
        } else {
          matchDiv.html('<span class="text-danger"><i class="fas fa-times-circle me-1"></i>Passwords do not match</span>');
        }
      } else {
        matchDiv.html('');
      }
  ...
  function checkPasswordStrength(password) {
    ...
    if (password.length > 0) {
      strengthBar.css({
        ...
        'background-color': colors[strength - 1] || '#dc3545',
        'height': '5px',
        'border-radius': '3px',
        'transition': 'all 0.3s ease'
      }).show().html(`
                    <div class="mt-1 small text-${strength >= 4 ? 'success' : strength >= 2 ? 'warning' : 'danger'}">
                        ${messages[strength - 1] || 'Very Weak'}
                    </div>
                `);
    } else {
      strengthBar.hide().html('');
    }
  }
</script>
</body>

...
%{--  <title>Task Details - InternTrack</title>--}%
...
%{--                  <small class="text-muted ms-2">(${Math.round(attachment.fileSize / 1024)} KB)</small>--}%
%{--                </div>--}%
...
%{--            <td><g:formatDate date="${task.dateCreated}" format="dd/MM/yyyy"/></td>--}%
%{--          </tr>--}%
%{--          <tr>--}%
%{--            <td class="text-muted">Last Updated:</td>--}%
%{--            <td><g:formatDate date="${task.lastUpdated}" format="dd/MM/yyyy HH:mm"/></td>--}%
%{--          </tr>--}%
%{--        </table>--}%
%{--      </div>--}%
%{--    </div>--}%

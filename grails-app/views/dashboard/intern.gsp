...
%{--                        <div>--}%
%{--                            <h4 class="mb-1">Welcome, ${intern?.user?.fullName}!</h4>--}%
%{--                            <p class="text-muted mb-0">${intern?.university} - ${intern?.major}</p>--}%
%{--                        </div>--}%
%{--                        <div class="text-end">--}%
...
%{--                    <div class="row">--}%
%{--                        <div class="col-md-4">--}%
%{--                            <p><strong>Student ID:</strong> ${intern?.studentId}</p>--}%
%{--                        </div>--}%
%{--                        <div class="col-md-4">--}%
%{--                            <p><strong>Supervisor:</strong> ${intern?.supervisor?.user?.fullName}</p>--}%
%{--                        </div>--}%
%{--                        <div class="col-md-4">--}%
...
%{--                    <div class="row">--}%
%{--                        <div class="col-md-4">--}%
%{--                            <p><strong>Start Date:</strong> <g:formatDate date="${intern?.startDate}" format="dd/MM/yyyy"/></p>--}%
%{--                        </div>--}%
%{--                        <div class="col-md-4">--}%
%{--                            <p><strong>End Date:</strong> <g:formatDate date="${intern?.endDate}" format="dd/MM/yyyy"/></p>--}%
%{--                        </div>--}%
%{--                        <div class="col-md-4">--}%
%{--                            <p><strong>Days Remaining:</strong>--}%
%{--                                <span class="badge ${remainingDays > 30 ? 'bg-success' : remainingDays > 7 ? 'bg-warning' : 'bg-danger'}">--}%
%{--                                    ${remainingDays} days--}%
%{--                                </span>--}%
%{--                            </p>--}%
%{--                        </div>--}%
...
%{--                    <g:link controller="task" action="create" class="btn btn-sm btn-primary">--}%
...
%{--                                                <span class="ms-2 badge priority-${task.priority.toLowerCase()}">${task.priority}</span>--}%
%{--                                            </p>--}%
%{--                                            <p class="small mb-0">${task.description?.truncate(100)}</p>--}%
%{--                                        </div>--}%
%{--                                        <div class="text-end">--}%
%{--                                            <span class="status-badge status-${task.status.toLowerCase()}">${task.status}</span>--}%
%{--                                            <div class="mt-2">--}%
%{--                                                <g:link controller="task" action="show" id="${task.id}" class="btn btn-sm btn-outline-primary">--}%
...
%{--                    <g:link controller="task" action="index" class="btn btn-sm btn-outline-primary">View All Tasks</g:link>--}%
%{--                </div>--}%
%{--            </div>--}%
%{--        </div>--}%
...
%{--                    <g:link controller="weeklyReport" action="create" class="btn btn-sm btn-primary">--}%
...
%{--                    </g:if>--}%
%{--                    <g:else>--}%
%{--                        <p class="text-muted text-center py-3">No reports submitted yet</p>--}%
%{--                    </g:else>--}%
%{--                </div>--}%
%{--                <div class="card-footer text-center">--}%
%{--                    <g:link controller="weeklyReport" action="index" class="btn btn-sm btn-outline-primary">View All Reports</g:link>--}%
%{--                </div>--}%
%{--            </div>--}%
%{--        </div>--}%
...
%{--                        <div class="progress">--}%
%{--                            <div class="progress-bar" style="width: ${taskStats?.completionRate ?: 0}%"></div>--}%
%{--                        </div>--}%
%{--                        <div class="text-end small text-muted mt-1">${taskStats?.completionRate ?: 0}% Complete</div>--}%
%{--                    </div>--}%
%{--                </div>--}%
%{--            </div>--}%
%{--        </div>--}%
...
%{--                    </div>--}%
%{--                    <div class="mt-3">--}%
%{--                        <label class="form-label">Average Hours per Week</label>--}%
%{--                        <div class="progress">--}%
%{--                            <div class="progress-bar" style="width: ${Math.min(reportStats?.avgHours ?: 0, 100)}%"></div>--}%
%{--                        </div>--}%
%{--                        <div class="text-end small text-muted mt-1">${reportStats?.avgHours ?: 0} hours/week</div>--}%
%{--                    </div>--}%
%{--                </div>--}%
%{--            </div>--}%
%{--        </div>--}%
...
%{--                    // Update task stats--}%
%{--                    if (data.taskStats) {--}%
%{--                        $('.stat-number').eq(0).text(data.taskStats.total);--}%
%{--                        $('.stat-number').eq(1).text(data.taskStats.completionRate + '%');--}%
%{--                        $('.progress-bar').eq(0).css('width', data.taskStats.completionRate + '%');--}%
%{--                    }--}%
%{--                }--}%
%{--            });--}%
%{--        }, 30000);--}%
...
%{--        // Observe first stat card--}%
%{--        if ($('.stat-card').length > 0) {--}%
%{--            observer.observe($('.stat-card')[0]);--}%
%{--        }--}%
...
%{--            var remainingDays = ${remainingDays ?: 45};--}%
%{--            var badge = $('.badge:contains("days")');--}%
